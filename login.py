...
class Login:
    ...
    filePath = path + '\session_cookie.txt'
    ...
    def loginByAuthentication(self, session):
        """
        ...
        try:
            ...
            response = session.post(self.login_url, data=dataAndCredentials, headers=Login.headers, verify=False)
    ...
    def SessionMaintain(self, home_url, session):
        """
        ...
        try:
            ...
            response = session.get(self.home_url, verify=False)
        ...
        def Getcsrf(self):
            """
            Get the csrf parameter (this function is not necessary for the moment)
            """
